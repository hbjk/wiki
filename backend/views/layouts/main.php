...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/" class="logo">
            ...
            <span class="logo-lg"><b>YII</b>.DW</span>
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <form action='<?php echo Url::to(["/be/logout"]);?>' method="post">
                                <div class="pull-right">
                                    <input type="hidden" name="<?php echo Yii::$app->request->csrfParam;?>" value="">
            ...
            <?php if (isset($this->params['breadcrumbs'])): ?>
                ...
                \yii\widgets\Breadcrumbs::widget(
                    [
                        'encodeLabels' => false,
                        'homeLink' => [
                            'label' => new \rmrevin\yii\fontawesome\component\Icon('home') . ' 首页',
                            'url' => '/',
                        ],
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; <a href="javacript:;">Yiidw</a> <?= date("Y") ?>
    </footer>
